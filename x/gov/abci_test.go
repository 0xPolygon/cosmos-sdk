...
func TestEndBlockerProposalHandlerFailed(t *testing.T) {
	...
	msg := banktypes.NewMsgSend(authtypes.NewModuleAddress(types.ModuleName), addrs[0], sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, math.NewInt(100000000000000000))))
