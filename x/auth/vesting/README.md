...
```bash
heimdalld tx vesting create-periodic-vesting-account [to_address] [periods_json_file] [flags]
```

Example:

```bash
heimdalld tx vesting create-periodic-vesting-account cosmos1.. periods.json
```
...
```bash
heimdalld tx vesting create-vesting-account [to_address] [amount] [end_time] [flags]
```

Example:

```bash
heimdalld tx vesting create-vesting-account cosmos1.. 100stake 2592000
```
